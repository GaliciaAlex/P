            ...
            <div class="modal-body">
                <form method="post" id="frmCliente">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="direccion" class="form-control" name="direccion" placeholder="Dirercción" rows="3"></textarea>
                    </div>
                    <button class="btn btn-primary" type="button" onclick="registarCli(event);" id="btnAccion">Registrar</button>
